defmodule ShopeecrawlerWeb.PageController do
  ...
  def index(conn, params) do
    ...
    items = SimpleCache.get(ShopeeSpider, :fetch, ["#{@url}&shop_categoryids=#{shop_categoryids}", params], ttl: 10)

    categories = SimpleCache.get(ShopeeSpider, :fetch_cats, [@url_category], ttl: 60)
